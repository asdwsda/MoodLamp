...
void handleRoot() {
    ...
    msg += "\tArguments:\n";
    msg += "\t\tid:\tId of the LED to set. If not set, all leds will be set.\n";
    msg += "\t\tr:\tRed color component. Will be 0 if not set.\n";
    msg += "\t\tg:\tGreen color component. Will be 0 if not set.\n";
    msg += "\t\tb:\tBlue color component. Will be 0 if not set.\n";
    msg += "/rainbow: Control rainbow mode.\n";
    msg += "\tArguments:\n";
    msg += "\t\tstart:\tStart rainbow animation.\n";
    msg += "\t\tstop:\tStop rainbow animation and set LEDs to set color to 0\n";
    msg += "\t\tpause:\tPause rainbow animation. \n";
